        ...
        <div class="column">
            <?php if($withdrawals->isEmpty()): ?>
                <div class="ui segment">
                    <p><?php echo __('accounting::text.withdrawals_empty', ['href' => route('frontend.account.show', [Auth::user()])]); ?></p>
                </div>
            <?php else: ?>
                <table class="ui selectable tablet stackable <?php echo e($inverted); ?> table">
                    ...
                    <?php $__currentLoopData = $withdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td data-title="<?php echo e(__('accounting::text.status')); ?>" class="<?php echo e($withdrawal->status == Packages\Accounting\Models\Withdrawal::STATUS_COMPLETED ? 'positive' : (in_array($withdrawal->status, [Packages\Accounting\Models\Withdrawal::STATUS_REJECTED, Packages\Accounting\Models\Withdrawal::STATUS_CANCELLED]) ? 'negative' : '')); ?>">
                                <?php echo e(__('accounting::text.withdrawal_status_' . $withdrawal->status)); ?>

                                <?php if($withdrawal->comments): ?>
                                    <span data-tooltip="<?php echo e($withdrawal->comments); ?>">
                                        <i class="info tooltip icon"></i>
                                    </span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="right aligned mobile-center">
                                <a href="<?php echo e(route('frontend.withdrawals.create', [Auth::user(), $withdrawal->withdrawal_method_id, 'amount' => $withdrawal->amount])); ?>" class="ui tiny icon <?php echo e($settings->color); ?> button">
